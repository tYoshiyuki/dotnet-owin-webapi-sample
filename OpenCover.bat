...
set TARGET_TEST="DoteNetOwinWebApiSample.Api.Test.dll /Logger:trx;LogFileName=DoteNetOwinWebApiSample.Api.Test.trx"
...
rem set FILTERS="+[DoteNetOwinWebApiSample.*]* -[*.Test.*]*"
